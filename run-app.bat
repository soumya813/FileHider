...
java ^
  --module-path "%USERPROFILE%\.m2\repository\org\openjfx\javafx-controls\21.0.2;%USERPROFILE%\.m2\repository\org\openjfx\javafx-fxml\21.0.2;%USERPROFILE%\.m2\repository\org\openjfx\javafx-base\21.0.2;%USERPROFILE%\.m2\repository\org\openjfx\javafx-graphics\21.0.2" ^
